                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <table  class="table table-hover">
                                ...
                                @foreach($awardsData as $key=>$faculty)
                                    <tr>
                                        <td>{{$key1++}}</td>
                                        <td>{{$faculty->title}}
                                        </td>
                                        ...
                                        <td>
                                            <form action="{{route('admin-awards.destroy',$faculty->id)}}"
                                                  method="post">
                                                @csrf
                                                @method('delete')
                                                <a href="{{route('admin-awards.show',$faculty->id)}}"
                                                   class="btn btn-info">
                                                    <i class="bi bi-eye-fill"></i>
                                                </a>
                                                <a href="{{route('admin-awards.edit',$faculty->id)}}"
