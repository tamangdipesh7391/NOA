        ...
        <section class="section dashboard">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form action="{{route('admin-awards.update',$awardsData->id)}}" method="post"
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <div class="form-group mb-2">
                                            ...
                                            <textarea name="meta_title" class="form-control"
                                                      id="meta_title">{{$awardsData->meta_title}}</textarea>
                                        </div>
                                        <div class="form-group mb-2">
                                            <label for="meta_description">Meta Description</label>
                                            <textarea name="meta_description" id="meta_description"
                                                      style="resize: none;" class="form-control"
                                                      rows="4"> {{$awardsData->meta_description}}</textarea>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group mb-2">
                                            ...
                                            <select name="status" id="status"
                                                    class="form-control">
                                                <option
                                                    value="1" {{ $awardsData->status == '1' ? 'selected' : '' }}>
                                                    Public
                                                </option>
                                                <option
                                                    value="0" {{$awardsData->status == '0' ? 'selected' : '' }}>
                                                    Draft
                                                </option>
                                        ...
                                        <div class="form-group mb-2 mb-2">
                                            ...
                                            <select name="menu_id" id="menu"
                                                    class="form-control">
                                                <option value="{{$awardsData->menu->id ?? ""}}">
                                                    {{$awardsData->menu->name ?? ""}}
                                                </option>
                                ...
                                <div class="form-group mb-2">
                                    ...
                                    <textarea name="intro_text" id="summary"
                                              class="form-control"
                                              rows="4">{{$awardsData->intro_text}}</textarea>
                                </div>
                                ...
                                <div class="form-group mb-2">
                                    <button type="submit" class="btn btn-success">
                                        <i class="bi bi-pencil-square"></i> Update Award
                                    </button>
                                </div>
