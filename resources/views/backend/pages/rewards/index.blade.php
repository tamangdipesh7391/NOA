                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <table  class="table table-hover">
                                ...
                                @foreach($rewardsData as $key=>$faculty)
                                    <tr>
                                        <td>{{$key1++}}</td>
                                        <td>{{$faculty->title}}
                                        </td>
                                        ...
                                        <td>
                                            <form action="{{route('admin-rewards.destroy',$faculty->id)}}"
                                                  method="post">
                                                @csrf
                                                @method('delete')
                                                <a href="{{route('admin-rewards.show',$faculty->id)}}"
                                                   class="btn btn-info">
                                                    <i class="bi bi-eye-fill"></i>
                                                </a>
                                                <a href="{{route('admin-rewards.edit',$faculty->id)}}"
