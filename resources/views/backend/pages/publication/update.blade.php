        ...
        <section class="section dashboard">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form action="{{route('admin-publication.update',$publicationData->id)}}"
                                  method="post"
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <div class="form-group mb-2">
                                            ...
                                            <textarea name="meta_title" class="form-control"
                                                      id="meta_title">{{$publicationData->meta_title}}</textarea>
                                        </div>
                                        <div class="form-group mb-2">
                                            <label for="meta_description">Meta Description</label>
                                            <textarea name="meta_description" id="meta_description"
                                                      style="resize: none;" class="form-control"
                                                      rows="4"> {{$publicationData->meta_description}}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group mb-2">
                                            ...
                                            <select name="type" id="status"
                                                    class="form-control">
                                                <option
                                                    value="normal" {{ $publicationData->type == 'normal' ? 'selected' : '' }}>
                                                    Normal
                                                </option>
                                                <option
                                                    value="advanced" {{ $publicationData->type  == 'advanced' ? 'selected' : '' }}>
                                                    Advanced
                                                </option>
                                            </select>
                                        </div>
                                        <div class="form-group mb-2">
                                            ...
                                            <select name="status" id="status"
                                                    class="form-control">
                                                <option
                                                    value="1" {{ $publicationData->status == '1' ? 'selected' : '' }}>
                                                    Public
                                                </option>
                                                <option
                                                    value="0" {{$publicationData->status == '0' ? 'selected' : '' }}>
                                                    Draft
                                                </option>
                                        ...
                                        <div class="form-group mb-2 mb-2">
                                            ...
                                            <select name="menu_id" id="menu"
                                                    class="form-control">
                                                <option value="{{$publicationData->menu->id ?? ""}}">
                                                    {{$publicationData->menu->name ?? ""}}
                                                </option>
                                        ...
                                        <div class="form-group mb-2">
                                            @if($publicationData->image)
                                                <img src="{{url($publicationData->image)}}"
                                                     id="image_show" alt="{{$publicationData->title}}"
                                                     class="img-fluid" style="margin-top: 23px;height: 100px;">
                                            @else
                                                <img src="{{url('icons/ui.png')}}"
                                                     class="img-fluid" id="image_show" alt="{{$publicationData->title}}"
                                ...
                                <div class="form-group mb-2">
                                    ...
                                    <textarea name="intro_text" id="summary"
                                              class="form-control"
                                              rows="4">{{$publicationData->intro_text}}</textarea>
                                </div>
