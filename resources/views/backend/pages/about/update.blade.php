                            ...
                            <form action="{{route('admin-about.update',$aboutData->id)}}" method="post"
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <div class="form-group mb-2">
                                            ...
                                            <textarea name="meta_title" class="form-control"
                                                      id="meta_title">{{$aboutData->meta_title}}</textarea>
                                        </div>
                                        <div class="form-group mb-2">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group mb-2 mb-2">
                                            ...
                                            <select name="menu_id" id="menu"
                                                    class="form-control">
                                                <option value="{{$aboutData->menu->id ?? ""}}">
                                                    {{$aboutData->menu->name ?? ""}}
                                                </option>
                                ...
                                <div class="form-group mb-2">
                                    ...
                                    <textarea name="intro_text" id="summary"
                                              class="form-control"
                                              rows="4">{{$aboutData->intro_text}}</textarea>
                                </div>
                                ...
                                <div class="form-group mb-2">
                                    <button type="submit" class="btn btn-success">
                                        <i class="bi bi-pencil-square"></i> Update About
                                    </button>
                                </div>
