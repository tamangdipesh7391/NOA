                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <table id="datatable" class="table table-striped table-bordered">
                                ...
                                @foreach($aboutData as $key=>$faculty)
                                    <tr>
                                        <td>{{$key1++}}</td>
                                        <td>{{$faculty->title}}
                                        </td>
                                        ...
                                        <td>
                                            <form action="{{route('admin-about.destroy',$faculty->id)}}"
                                                  method="post">
                                                @csrf
                                                @method('delete')
                                                <a href="{{route('admin-about.show',$faculty->id)}}"
                                                   class="btn btn-info">
                                                    <i class="bi bi-eye-fill"></i>
                                                </a>
                                                <a href="{{route('admin-about.edit',$faculty->id)}}"
